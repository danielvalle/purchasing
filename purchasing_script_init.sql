...
CREATE TABLE abstract_quotation
    (
      ...
      `requesting_officer_fk` int,
      `board_secretary_fk` int,
      `vpaf_fk` int,
      `approve_fk` int,
      `supervising_admin_designation_fk` int,
      `admin_officer_designation_fk` int,
      `admin_officer_2_designation_fk` int,
      `requesting_officer_designation_fk` int,
      `board_secretary_designation_fk` int,
      `vpaf_designation_fk` int,
      `approve_designation_fk` int,
      `pr_fk` int,
      `is_active` tinyint(1),
      `created_at` date,
      `updated_at` date,
      ...
      FOREIGN KEY(requesting_officer_fk) REFERENCES user(id),
      ...
      FOREIGN KEY(supervising_admin_designation_fk) REFERENCES designation(id),
      FOREIGN KEY(admin_officer_designation_fk) REFERENCES designation(id),
      FOREIGN KEY(admin_officer_2_designation_fk) REFERENCES designation(id),
      FOREIGN KEY(requesting_officer_designation_fk) REFERENCES designation(id),
      FOREIGN KEY(board_secretary_designation_fk) REFERENCES designation(id),
      FOREIGN KEY(vpaf_designation_fk) REFERENCES designation(id),
      FOREIGN KEY(approve_designation_fk) REFERENCES designation(id),
      FOREIGN KEY(pr_fk) REFERENCES purchase_request(id)
    );
