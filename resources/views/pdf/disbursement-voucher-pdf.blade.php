                        ...
                        <tr>
                            ...
                            <th style="font-size: 14px; text-align: left; " >
                                <div style="padding: 5px 5px 10px 10px;">
                                    <div>
                                    <input style="width: 10%; float: left" for="inspected" type="checkbox" value="1" checked>
            ...
            <table style="width: 100%;">
                ...
                <tbody>
                    <tr>
                        ...
                        <th style="width: 40%; border-right: thin solid black">
        ...
        <div>
            <table style=" width: 100%;">
                    ...
                    <tbody>  
                        ...
                        <tr>
                            <th style="width: 10%; text-align: center; border-bottom: thin solid black; font-weight: normal; padding: 3px 0px; border-right: thin solid black; font-size: 14px">Printed Name</th>
                            <th style="width: 40%; text-align: center; border-bottom: thin solid black; font-weight: bold; padding: 3px 0px; border-right: thin solid black; font-size: 16px"></th>
                            <th style="width: 10%; text-align: center; border-bottom: thin solid black; font-weight: normal; padding: 3px 0px; border-right: thin solid black; font-size: 14px">Printed Name</th>
                            <th style="width: 40%; text-align: center; border-bottom: thin solid black; font-weight: bold; padding: 3px 0px; font-size: 16px"></th>
                        </tr>
                        <tr>
            ...
            <table style=" width: 100%; border-top: 0 !important">
                    ...
                    <tbody>  
                        ...
                        <tr>
                            ...
                            <th style="width: 20%; text-align: left; border-bottom: thin solid black; font-weight: normal; padding: 3px 2px; border-right: thin solid black; font-size: 14px">Date</th>
                            <th style="width: 30%; text-align: center; border-bottom: thin solid black; font-weight: normal; padding: 3px 2px; border-right: thin solid black; font-size: 14px">
                                ...
                                <div style="text-align: left; font-size: 13px">LBP-SOGOD</div>
                            </th>
                            <th style="width: 10%; text-align: center; border-bottom: thin solid black; font-weight: bold; padding: 3px 0px; font-size: 16px"></th>
                        </tr> 
                        <tr>
                        ...
                        <th style="text-align: center; font-weight: normal; padding: 3px 2px;">&nbsp;</th>
                    </tr>
                    </tbody>
            </table>
        </div>
